...
use "$DATA\NLSPHS_2012_noresp.dta", clear
tab survresp
save "$DATA\NLSPHS_2012_noresp", replace
...
save "$DATA\nlsphs_tot", replace
append using "$DATA\NLSPHS_2012_noresp"
tab survresp yearsurvey
...
-----------+--------------------------------------------+----------
         0 |       143        118        116        528 |       905 
         1 |       354        236        241        525 |     1,356 
-----------+--------------------------------------------+----------
     Total |       497        354        357      1,053 |     2,261 
...
drop ef1-ef19 county_06 ptcnty_06 
tab survresp yearsurvey
...
drop  TBD responded yearsurv12 NLSPHS_responded SelecProb_TBD pw_TBD
